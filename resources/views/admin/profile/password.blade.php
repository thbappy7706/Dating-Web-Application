        ...
        <div class="row justify-content-center mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.password') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="old_password" class="form-control  " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" old_password">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="new_password" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="new_password">
            ...
            <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="{{ asset('img/user.png') }}" height="280px;" width="20px;" alt="Card image cap">
